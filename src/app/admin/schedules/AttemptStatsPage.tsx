        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-sm font-medium">{fraudAttempts}</div>
              </CardContent>
            </Card>
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">Tiempo Fuera de la Evaluación</CardTitle>
                <Clock className="h-4 w-4 text-muted-foreground" />
              </CardHeader>
              <CardContent>
                <div className="text-sm font-medium">{totalTimeOutside} segundos</div>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="h-[300px] w-full">
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                <Line type="monotone" dataKey="fraudAttempts" stroke="#82ca9d" activeDot={{ r: 8 }} />
                <Line type="monotone" dataKey="timeOutsideEval" stroke="#ff7300" activeDot={{ r: 8 }} />
              </LineChart>
            </ResponsiveContainer>
          </div>
