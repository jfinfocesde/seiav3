...
import { Users, FileText, Calendar, Send, AlertTriangle, Clock, KeyRound, CheckCircle, UserCheck } from "lucide-react";
import {
  Table,
  TableBody,
  TableCell,
                    ...
                    <TableCell className="text-center space-x-2">
                      {stat.fraudAttempts > 0 && (
                        <Badge variant="destructive" className="flex-shrink-0">
                          ...
                          {stat.fraudAttempts} {stat.fraudAttempts > 1 ? 'Alertas' : 'Alerta'}
                        </Badge>
                      )}
                      {stat.timeOutsideEval > 0 && (
                        <Badge variant="secondary" className="flex-shrink-0">
                          <Clock className="h-3 w-3 mr-1" />
                          {formatDuration(stat.timeOutsideEval)} fuera
                        </Badge>
                      )}
                    </TableCell>
                  </TableRow>
